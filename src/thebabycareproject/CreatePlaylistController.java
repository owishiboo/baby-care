...
public class CreatePlaylistController implements Initializable {
     ...
     */
    @FXML 
    void but1_del(ActionEvent event){
     ...
     */
    @FXML 
    void but2_del(ActionEvent event){
     ...
     */
    @FXML 
    void but3_del(ActionEvent event){
     ...
     */
    @FXML 
    void but4_del(ActionEvent event){
     ...
     */
    @FXML 
    void but5_del(ActionEvent event){
     ...
     */
    @FXML 
    void but6_del(ActionEvent event){
     ...
     */
    @FXML 
    void but7_del(ActionEvent event){
     ...
     */
    @FXML 
    void but8_del(ActionEvent event){
     ...
     */
    @FXML 
    void but9_del(ActionEvent event){
     ...
     */
    @FXML 
    void but10_del(ActionEvent event){
