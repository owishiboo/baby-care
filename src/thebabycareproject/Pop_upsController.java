...
public class Pop_upsController implements Initializable {
    ...
    void clickHere(ActionEvent event){
        ...
        dialogLayout.setBody(new Text("Set the time and date to get a reminder-email in case\n" +
"you are getting panicked of so many tasks.\n" +
"Don't panic! So don't forget to care!\n" +
"The reciever is the email address that you use to\n" +
"sign in."));
